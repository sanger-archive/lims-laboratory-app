...
describe "create_and_read_a_fluidigm_resource", :fluidigm => true do
  include_context "use core context service"
  it "create_and_read_a_fluidigm_resource" do


  # **Use the create fluidigm action.**
  # * `number_of_rows` number of rows of the fluidigm
  # * `number_of_columns` number of columns of the fluidigm
  # * `fluidigm_wells_description` map aliquots to wells
    ...
    response = post "/actions/create_fluidigm", <<-EOD
    {
    "create_fluidigm": {
        "number_of_rows": 16,
  ...
  # **Reads the previously created fluidigm.**
