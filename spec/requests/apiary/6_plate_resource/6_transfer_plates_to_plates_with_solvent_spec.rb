...
describe "transfer_plates_to_plates_with_solvent", :plate => true do
  include_context "use core context service"
  it "transfer_plates_to_plates_with_solvent" do
  ...
  # * `aliquot_type` set a new type for all aliquots in the target plate-like asset
    ...
    solvent1 = Lims::LaboratoryApp::Laboratory::Aliquot.new(:type => Lims::LaboratoryApp::Laboratory::Aliquot::Solvent, :quantity => 100)
    source_plate1["A1"] << solvent1
    ...
    solvent2 = Lims::LaboratoryApp::Laboratory::Aliquot.new(:type => Lims::LaboratoryApp::Laboratory::Aliquot::Solvent, :quantity => 100)
    source_plate2["C3"] << solvent2
