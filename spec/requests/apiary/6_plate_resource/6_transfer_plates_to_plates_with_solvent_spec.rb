...
describe "transfer_plates_to_plates_with_solvent", :plate => true do
  ...
  # * `aliquot_type` set a new type for all aliquots in the target plate-like asset
    ...
    solvent1 = Lims::Core::Laboratory::Aliquot.new(:type => Lims::Core::Laboratory::Aliquot::Solvent, :quantity => 100)
    ...
    solvent2 = Lims::Core::Laboratory::Aliquot.new(:type => Lims::Core::Laboratory::Aliquot::Solvent, :quantity => 100)
