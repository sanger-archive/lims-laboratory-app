...
describe "tranfer_the_content_from_multiples_tubes_to_multiples_tubes", :tube => true do
  ...
  # and spin columns to tubes transfer.**
    ...
    source_tube1 = Lims::LaboratoryApp::Laboratory::Tube.new << Lims::LaboratoryApp::Laboratory::Aliquot.new(:quantity => 10, :type => "RNA", :sample => sample1)
    source_tube2 = Lims::LaboratoryApp::Laboratory::Tube.new << Lims::LaboratoryApp::Laboratory::Aliquot.new(:quantity => 10, :type => "RNA", :sample => sample2)
    target_tube1 = Lims::LaboratoryApp::Laboratory::Tube.new
    target_tube2 = Lims::LaboratoryApp::Laboratory::Tube.new
